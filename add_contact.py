...
from ApplicationContact import Application
import pytest
...
def test_add_contact(app):
    app.login(adminName="admin", password="secret")
    app.create_new_contact(Contact(firstName="5", middleName="2", lastName="3", nickName="4", title="5",
...
def test_add_empty_contact(app):
    app.login(adminName="admin", password="secret")
    app.create_new_contact(Contact(firstName="", middleName="", lastName="", nickName="", title="",
